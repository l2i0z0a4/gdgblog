...
const Homealumni = () => {
    ...
    useEffect(() => {
        ...
        const memberList = [
            ...
            { id: 3, name: "Michael Doe", email: "michael@example.com", role: "alumni", specialty: "software engineer", image: femme},
        ];
        const blogList = [
            { id: 1, title: "How to become a software engineer", content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In egetttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt", creator: "John Doe", creatorImage: homme, date: "2022-10-10" },
